...
public class FrmTelaAlterarDentista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Alterar dados do Dentista");
        setResizable(false);
        ...
        jbTitulo.setText("Alterar Dados do Dentista");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(226, 226, 226)
                .addComponent(jbTitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jbSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSalvarActionPerformed
        ...
        if((validaCampos() == true)) {
            ...
            if(controleDentista.atualizarDentista(dentista)){
                JOptionPane.showMessageDialog(this, "Dentista atualizado com sucesso!");
                limparCampos();
                this.dispose();
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTelaAlterarDentista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new FrmTelaAlterarDentista().setVisible(true);
            }
        });
    }
