...
public class FrmTelaAlterarPaciente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbTitulo.setText("Alterar Dados do Paciente");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(226, 226, 226)
                .addComponent(jbTitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jbSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSalvarActionPerformed
        ...
        if((validaCampos() == true)) {
            ...
            if(controlePaciente.atualizarPaciente(paciente)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTelaAlterarPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new FrmTelaAlterarPaciente().setVisible(true);
            }
        });
    }
    ...
    //funcao que obriga usuario informar os dados corretamente
