...
public class FrmTelaAlterarSecretaria extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Alterar Dados da Secretária");
        setResizable(false);
        ...
        jbTitulo.setText("Alterar Dados da Secretária");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(226, 226, 226)
                .addComponent(jbTitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jbSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSalvarActionPerformed
        ...
        if((validaCampos() == true)) {
            ...
            //chama a funcao atualiza
            if(controleSecretaria.atualizarSecretaria(secretaria)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTelaAlterarSecretaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new FrmTelaAlterarSecretaria().setVisible(true);
            }
        });
    }
    ...
    //funcao que obrica usuario informar os dados corretamente
    public boolean validaCampos() {  
        ...
        if(!(jrMasculino.isSelected()) && !(jrFeminino.isSelected())){
            JOptionPane.showMessageDialog(this, "Informe o sexo do secretaria!");
    ...
    //funcao para limpar os campos
     public void limparCampos() {        
            ...
            jftCelular.setText("");       
            jtfEmail.setText("");        
            //retorna foco para nome(primeiro item do cadastro)
            jtfNome.requestFocus();
        }
